...
export const CHAPTERS = [
  ...
  },
  {
    ...
    after: [
      ...
      "L'Horloger n'a pas dit un mot le jour de l'annonce. Il a seulement fait remarquer, plus tard, que l'usine, elle, tournait toujours.",
    ],
  },
  {
  ...
  },
  {
    ...
    before: [
      ...
      "Et l'ironie est complète : pour tarir l'usine, il faut lui prendre ses propres produits. Chaque mecha arraché à une faction est un mecha de moins sur le marché de Ford, et un de plus dans les mains de ceux qui l'ont assemblé. L'Horloger n'a jamais eu la libération des cockpits qu'il réclamait — il aura ça.",
    ...
    after: [
      ...
      "L'Horloger avait raison sur un point, et il l'a payé : détruire une machine de guerre n'a jamais suffi à empêcher la suivante. Les cockpits sont ouverts, maintenant. N'importe qui peut apprendre à les piloter — et n'importe qui, cette fois, veut dire n'importe qui.",
